...
for (const t of transcripts) {
    ...
    for (const line of lines) {
        ...
        try {
            ...
            if (t.includes('897f03a1-4610-4ef6-950a-bcaf6fc94c22') && obj.type === 'USER_INPUT') {
                if (obj.content && obj.content.includes('Continue')) {
            ...
            if (obj.tool_calls) {
                for (const call of obj.tool_calls) {
                    if (call.name === 'write_to_file') {
                        ...
                        fs.writeFileSync(call.args.TargetFile, content, 'utf-8');
